...
import { Calendar, Users, CreditCard, User, Mail, Phone, Hotel, Bed } from "lucide-react";
...
export const HotelBookingModal: React.FC<HotelBookingModalProps> = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const confirmationId = result?.data?.confirmationId || `WC2030-HTL-${Date.now()}`;
      
      toast({
        title: "🏨 Hotel Booking Confirmed!",
        description: `Your booking at ${hotelName} has been confirmed. Confirmation ID: ${confirmationId}`,
      });
      ...
      toast({
        ...
        description: "An error occurred while processing your hotel booking. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
      ...
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Select value={formData.roomType} onValueChange={(value) => handleInputChange('roomType', value)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="stadium-view">Stadium View Room</SelectItem>
                  <SelectItem value="worldcup-package">World Cup Package</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          ...
          <Button 
            ...
            disabled={isLoading}
          >
            {isLoading ? "Processing..." : "Confirm Hotel Booking"}
          </Button>
        </form>
      </DialogContent>
    </Dialog>
